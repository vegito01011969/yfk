...
class KaggleYtDlpVideoDownloadProvider(ColabYtDlpVideoDownloadProvider):
    ...
    def _kernel_source(self, job: dict[str, Any]) -> str:
        ...
        injected = (
            ...
            f"EMBEDDED_YT_DLP_ZIP_B64 = {json.dumps(self._yt_dlp_zip_b64())}\n"
            "\n\n"
            "def _prepare_embedded_inputs() -> None:\n"
            "    vendor_dir = REMOTE_DIR / 'vendor'\n"
            "    vendor_dir.mkdir(parents=True, exist_ok=True)\n"
            "    vendor_zip = REMOTE_DIR / 'yt_dlp_vendor.zip'\n"
            "    vendor_zip.write_bytes(__import__('base64').b64decode(\n"
            "        EMBEDDED_YT_DLP_ZIP_B64\n"
            "    ))\n"
